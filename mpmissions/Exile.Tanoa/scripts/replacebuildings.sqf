/*
    File: SearchAndDestroyCherno.sqf
    Author: Brun - Enigma Team
    Description: Search and Replace unenterable Napf buildings, is a little buggy for some.
*/
...
myBuildings = [["Land_HouseV_1I4","Land_i_Stone_HouseSmall_V3_F",270],
               ...
               ["Land_Shed_Ind02","Land_i_Shed_Ind_F",180],
               ["Land_Repair_center","Land_CarService_F",0],			   
               ["Land_Shed_M03","",90],
