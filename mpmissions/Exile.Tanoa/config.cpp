...
//  #include "TRADERS\CUPU\ItemListCUPU.hpp"
...
class CfgExileCustomCode 
{
	...
	*/
	...
	//Trader fixes for attachments
	ExileClient_util_gear_getCompatibleWeaponItems							= 		"fixes\ExileClient_util_gear_getCompatibleWeaponItems.sqf";
	ExileClient_util_item_getCompatibleWeaponItems							= 		"fixes\ExileClient_util_item_getCompatibleWeaponItems.sqf";
	...
	//Aircraft Trader Fixed Purchase Points
    ...
    ExileServer_object_player_database_load = "fixes\ExileServer_object_player_database_load.sqf";
    ExileServer_object_vehicle_database_load = "fixes\ExileServer_object_vehicle_database_load.sqf";
    ExileServer_object_vehicle_database_update = "fixes\ExileServer_object_vehicle_database_update.sqf";
    ExileServer_object_vehicle_network_unlockVehicleRequest = "fixes\ExileServer_object_vehicle_network_unlockVehicleRequest.sqf";
...
class CfgExileLootSettings
{
	 ...
	 */
	minimumDistanceToTraderZones = 75;
