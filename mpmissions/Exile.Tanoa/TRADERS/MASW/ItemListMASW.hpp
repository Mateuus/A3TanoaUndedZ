	...
	// Backpacks
	///////////////////////////////////////////////////////////////////////////////
	class B_mas_m_Bergen_us							{ quality = 2; price = 1100; };
	class B_mas_m_Bergen_us_g						{ quality = 2; price = 1100; };
	class B_mas_m_Bergen_us_m						{ quality = 2; price = 1100; };
	class B_mas_m_Bergen_us_b						{ quality = 2; price = 1100; };
	class B_mas_m_Bergen_us_w						{ quality = 2; price = 1100; };
	class B_mas_m_Bergen_acr						{ quality = 2; price = 1100; };
	class B_mas_m_Bergen_acr_c						{ quality = 2; price = 1100; };
	class B_mas_m_Bergen_acr_g						{ quality = 2; price = 1100; };
	class B_mas_m_Bergen_acr_w						{ quality = 2; price = 1100; };
	class B_mas_m_Bergen_rpg						{ quality = 2; price = 1100; };
	class B_mas_m_Bergen_rpg_b						{ quality = 2; price = 1100; };
	class B_mas_m_Bergen_al							{ quality = 2; price = 1100; };
	class B_mas_AssaultPack_mul						{ quality = 1; price = 90; };
	class B_mas_Kitbag_mul							{ quality = 3; price = 200; };
	class B_mas_Bergen_mul							{ quality = 2; price = 1100; };
	class B_mas_AssaultPack_des						{ quality = 1; price = 90; };
	class B_mas_Kitbag_des							{ quality = 3; price = 200; };
	class B_mas_Bergen_des							{ quality = 2; price = 1100; };
	class B_mas_AssaultPack_black					{ quality = 1; price = 90; };
	class B_mas_Kitbag_black						{ quality = 3; price = 200; };
	class B_mas_Bergen_black						{ quality = 2; price = 1100; };
	class B_mas_AssaultPack_wint					{ quality = 1; price = 90; };
	class B_mas_Kitbag_wint							{ quality = 3; price = 200; };
	class B_mas_Bergen_wint							{ quality = 2; price = 1100; };
	class B_mas_AssaultPack_rng						{ quality = 1; price = 90; };
	class B_mas_Kitbag_rng							{ quality = 3; price = 200; };
	class B_mas_Bergen_rng							{ quality = 2; price = 1100; };
	class O_mas_Bergen_flo							{ quality = 2; price = 1100; };
	class O_mas_Bergen_blk							{ quality = 2; price = 1100; };
	class O_mas_Bergen_rtan							{ quality = 2; price = 1100; };	
