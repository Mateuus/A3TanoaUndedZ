	...
	// Sub Machine Guns
	///////////////////////////////////////////////////////////////////////////////
	class 	hlc_smg_mp5k	 						{ quality = 1; price = 425; }; 	
	class	hlc_smg_mp5k_PDW					{ quality = 1; price = 550; };
	class	hlc_smg_mp5a2						{ quality = 1; price = 425; };
	class	hlc_smg_mp5a3						{ quality = 1; price = 425; };
	class	hlc_smg_mp5a4						{ quality = 1; price = 425; };
	class	hlc_smg_mp5n							{ quality = 1; price = 425; };
	class	hlc_smg_mp510						{ quality = 1; price = 425; };
	class	hlc_smg_mp5sd5						{ quality = 1; price = 425; };
	class	hlc_smg_mp5sd6						{ quality = 1; price = 425; };
	class	hlc_smg_9mmar						{ quality = 1; price = 425; };
	class	hlc_rifle_augpara						{ quality = 1; price = 425; };
	class	hlc_rifle_auga2para						{ quality = 1; price = 425; };

	///////////////////////////////////////////////////////////////////////////////
	// Light Machine Guns
	///////////////////////////////////////////////////////////////////////////////	
	class	hlc_rifle_RPK12							{ quality = 3; price = 1000; };
	class	hlc_rifle_rpk							{ quality = 3; price = 1000; };
	class	hlc_lmg_m60							{ quality = 3; price = 1000; };
	class	hlc_lmg_M60E4							{ quality = 3; price = 1000; };
	class	hlc_lmg_minimipara						{ quality = 3; price = 1000; };
	class	hlc_lmg_minimi			 				{ quality = 3; price = 1000; };
	class	hlc_lmg_minimi_railed					{ quality = 3; price = 1000; };
	class	hlc_lmg_m249para						{ quality = 3; price = 1000; };
	class	hlc_lmg_M249E2						{ quality = 3; price = 1000; };
	class	hlc_m249_pip1			 				{ quality = 3; price = 1000; };
	class	hlc_m249_pip2							{ quality = 3; price = 1000; };
	class	hlc_m249_pip3							{ quality = 3; price = 1000; };
	class	hlc_m249_pip4							{ quality = 3; price = 1000; };
	...
	class	hlc_rifle_ak12							{ quality = 2; price = 650; };
	class 	hlc_rifle_ak12gl							{ quality = 3; price = 650; };
	...
	class 	hlc_rifle_saiga12k						{ quality = 3; price = 650; };
	...
	class	hlc_rifle_auga1_t						{ quality = 3; price = 650; };
	class	hlc_rifle_auga1_B						{ quality = 3; price = 650; };
	class	hlc_rifle_auga1carb						{ quality = 3; price = 650; };
	class	hlc_rifle_auga1carb_t						{ quality = 3; price = 650; };
	class	hlc_rifle_auga1carb_b						{ quality = 3; price = 650; };
	class	hlc_rifle_aughbar						{ quality = 3; price = 650; };
	class	hlc_rifle_aughbar_b						{ quality = 3; price = 650; };
	class	hlc_rifle_aughbar_t						{ quality = 3; price = 650; };
	class	hlc_rifle_augpara_b						{ quality = 3; price = 650; };	
	class	hlc_rifle_augpara_t						{ quality = 3; price = 650; };
	class	hlc_rifle_auga2							{ quality = 3; price = 650; };
	class	hlc_rifle_auga2_b						{ quality = 3; price = 650; };
	class	hlc_rifle_auga2_t						{ quality = 3; price = 650; };	
	class	hlc_rifle_auga2carb						{ quality = 3; price = 650; };
	class	hlc_rifle_auga2carb_t						{ quality = 3; price = 650; };
	class	hlc_rifle_auga2carb_b 					{ quality = 3; price = 650; };	
	class	hlc_rifle_auga2lsw						{ quality = 3; price = 650; };
	class	hlc_rifle_auga2lsw_t						{ quality = 3; price = 650; };
	class	hlc_rifle_auga2lsw_b 					{ quality = 3; price = 650; };
	class	hlc_rifle_auga2para_b						{ quality = 3; price = 650; };
	class	hlc_rifle_auga2para_t						{ quality = 3; price = 650; };	
	class	hlc_rifle_augsr							{ quality = 3; price = 650; };
	class	hlc_rifle_augsr_b						{ quality = 3; price = 650; };	
	class	hlc_rifle_augsr_t						{ quality = 3; price = 650; };
	class	hlc_rifle_augsrcarb						{ quality = 3; price = 650; };
	class	hlc_rifle_augsrcarb_t						{ quality = 3; price = 650; };
	class	hlc_rifle_augsrcarb_b						{ quality = 3; price = 650; };
	class	hlc_rifle_augsrhbar						{ quality = 3; price = 650; };
	class	hlc_rifle_augsrhbar_b						{ quality = 3; price = 650; };
	class	hlc_rifle_augsrhbar_t						{ quality = 3; price = 650; };
	class	hlc_rifle_auga3							{ quality = 3; price = 650; };
	class	hlc_rifle_auga3_bl						{ quality = 3; price = 650; };
	class	hlc_rifle_auga3_b						{ quality = 3; price = 650; };
	class	hlc_rifle_auga3_GL						{ quality = 3; price = 650; };	
	class	hlc_rifle_auga3_GL_BL					{ quality = 3; price = 650; };
	class	hlc_rifle_auga3_GL_B					{ quality = 3; price = 650; };
	...
	// Sniper Rifles
	///////////////////////////////////////////////////////////////////////////////	
	class	hlc_rifle_M14		 					{ quality = 3; price = 1250; };
	class	hlc_rifle_M21							{ quality = 3; price = 1250; };
	class	hlc_rifle_M14DMR						{ quality = 3; price = 1250; };
	class	hlc_rifle_m14sopmod						{ quality = 3; price = 1250; };
	class	hlc_rifle_psg1							{ quality = 3; price = 1250; };
	class	hlc_rifle_awcovert						{ quality = 3; price = 1300; };
	class	hlc_rifle_awcovert_BL						{ quality = 3; price = 1300; };
	class	hlc_rifle_awcovert_FDE					{ quality = 3; price = 1300; };
	class	hlc_rifle_awmagnum						{ quality = 3; price = 1300; };
	class	hlc_rifle_awmagnum_BL					{ quality = 3; price = 1300; };
	class	hlc_rifle_awmagnum_FDE					{ quality = 3; price = 1300; };
	class	hlc_rifle_awMagnum_FDE_ghillie			{ quality = 3; price = 1300; };
	class	hlc_rifle_awMagnum_BL_ghillie				{ quality = 3; price = 1300; };
	class	hlc_rifle_awMagnum_OD_ghillie				{ quality = 3; price = 1300; };